  ...
  return (
    <>
      <div className="container w-full  my-[30px] flex flex-row mx-auto ">
        ...
        <div className="sticky-box w-[357px] h-[450px] m-4 shadow-[0px_5px_5px_0px_rgba(100,109,137,1)] px-6 py-8 rounded-xl fixed right-40">
          <div>
          ...
          <div className="sticky-box-btn-container border-t-2 border-[#d6d9e7] mt-6 ">
            <button className=" text-base text-[#F47E20] border-2 border-[#F47E20] rounded-xl font-bold mt-6 mb-3 px-4 py-6 w-[310px] h-[60px] leading-3">
              Get in Desire Course
            </button>
            <button className="bg-[#2F5FAC] rounded-xl text-white text-base font-bold px-4 py-6 w-[310px] h-[60px] text-center leading-4">
