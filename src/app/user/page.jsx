  ...
  return (
    <>
      ...
      <section className=" w-[330px]  mx-auto  mb-[40px] mt-[100px] ">
        <h1 className="   text-center mb-[60px]  text-[36px] ">My Courses</h1>
        ...
        <div className=" flex justify-between p-[8px] text-[16px]   font-normal  text-[#9AA1B9] ">
          <button
            className={` ${
              courseStatus === 0
                ...
                : ""
            } focus:text-black focus:underline focus:underline-offset-8 `}
            onClick={() => {
              setCourseStatus(0);
            }}
          >
          ...
          <button
            className="focus:text-black focus:underline focus:underline-offset-8"
            onClick={() => {
              setCourseStatus(1);
            }}
          >
