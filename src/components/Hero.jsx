...
function Hero() {
  return (
    <div className="hero relative w-auto min-md:h-[700px] min-[1440px]:h-[700px] bg-[#E5ECF8] z-0 min-[375px]:h-[500px]">
      <div className="box-border min-[768px]:flex justify-between items-center mx-[auto] p-[0px] max-w-[1120px] min-[1200px]:px-[0px]">
        <div className="box h-[370px] w-[643px] pt-[185px] min-[375px]:ml-[10px] min-[375px]:pt-[205px] min-[375px]:pl-[50px] min-[1024px]:pt-[205px]">
          <div className="topic min-[375px]:text-2xl min-[375px]:-mt-[60px] min-[375px]:w-[250px] lg:w-[643px] lg:text-[66px] lg:font-medium lg:leading-[125%] lg:tracking-[-1.32px]">
            Best Virtual Classroom Software
          </div>
          <div className="content min-[375px]:text-base min-[375px]:w-[350px] min-[375px]:pt-[30px] lg:w-[643px] lg:pt-[24px] lg:text-[20px] lg:text-[#646D89] lg:font-normal">
